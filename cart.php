<?php
       ...
       require_once ($_SERVER['DOCUMENT_ROOT'].'/qwerty/eshop/system/classes/autoload.php');
?>
...
<?php
    ...
    ?>
     ...
     <?php while ($line = mysqli_fetch_assoc($results)) 
                            ...
                            { ?>
                                        ...
                                        <div class="one-good">
                                                    ...
                                                    <div class="good">
                                                        ...
                                                        <div> <a href="http://localhost/qwerty/eshop/system/controllers/cart/delete_from_cart.php?id=<?=$line['id']?>">X</a>
                            </div>
                                                    </div>
                                        </div>
                               </a>
                            ...
                            <?php } }?>
                            <a href="http://localhost/qwerty/eshop/system/controllers/cart/empty_cart.php">empty</a>
